---
title: "Roteamento via Firewall Central (hub & spoke)"
date: 2025-10-22
categories: ["OCI", "Network"]
tags: ["VCN", "DRG", "Subnet", "Firewall", "Hub & Spoke"]
---
...
No diretório <a href="https://github.com/daniel-armbrust/oci-network-basics/tree/main/scripts/roteamento-via-firewall-central" target="_blank">`scripts/roteamento-via-firewall-central`</a> há um conjunto de scripts para criar a topologia apresentada através do OCI CLI. 

...
date: 2025-12-15
categories: ["OCI", "Network"]
tags: ["VCN", "DRG", "Network Visualizer"]
---
...
![Network Viualizer #1](img/network-visualizer-1.png)
...
![Network Viualizer #2](img/network-visualizer-2.png)
...
![Network Viualizer #3](img/network-visualizer-3.png)
...
![Network Viualizer #4](img/network-visualizer-4.png)
...
![Network Viualizer #5](img/network-visualizer-5.png)

Neste caso, consulta-se a tabela do DRG `drg-attch-rt_vcn-appl-1` para determinar o próximo salto:

![Network Viualizer #6](img/network-visualizer-6.png)

![Network Viualizer #7](img/network-visualizer-7.png)

Redes importadas para este anexo via route distribution `import-routes_vcn-appl-1`:

![Network Viualizer #8](img/network-visualizer-8.png)
...
![Network Viualizer #9](img/network-visualizer-9.png)
...
![Network Viualizer #10](img/network-visualizer-10.png)
...
![Network Viualizer #11](img/network-visualizer-11.png)
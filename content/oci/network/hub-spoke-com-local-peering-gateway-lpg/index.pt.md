---
title: "Hub & Spoke com Local Peering Gateway (LPG)"
date: 2025-11-03
categories: ["OCI", "Network"]
tags: ["VCN", "DRG", "Subnet", "Local Peering", "Hub & Spoke"]
---
...
No diretório <a href="https://github.com/daniel-armbrust/oci-network-basics/tree/main/scripts/hub-spoke-com-local-peering-gateway" target="_blank">`scripts/hub-spoke-com-local-peering-gateway/`</a> há um conjunto de scripts para criar a topologia apresentada através do OCI CLI. 
